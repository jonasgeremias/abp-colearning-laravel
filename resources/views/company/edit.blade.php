...
<form action="{{ route('company.update', $company) }}" method="post" encType="multipart/form-data">
	...
	<fieldset>
		...
		<div class="form-group @if ($errors->has('nome_fantasia')) has-error @endif">
			...
			<input type="text" class="form-control" id="nome_fantasia" name="nome_fantasia" value="{{ old("nome_fantasia", $company->nome_fantasia) }}">
		...
		<div class="form-group @if ($errors->has('razao_social')) has-error @endif">
			...
			<input type="text" class="form-control" id="razao_social" name="razao_social" value="{{ old("razao_social", $company->razao_social) }}">
		...
		<div class="form-group @if ($errors->has('cnpj')) has-error @endif">
			...
			<input type="text" class="form-control" id="cnpj" name="cnpj" value="{{ old("cnpj", $company->cnpj) }}">
			@if ($errors->has('cnpj'))
			<span class="invalid-feedback help-block" role="alert">
		...
		<div class="form-group @if ($errors->has('part_satc')) has-error @endif">
			...
			<input type="text" class="form-control" id="part_satc" name="part_satc" value="{{ old("part_satc", $company->part_satc) }}">
		...
		<div class="form-group @if ($errors->has('nome_ceo')) has-error @endif">
			...
			<input type="text" class="form-control" id="nome_ceo" name="nome_ceo" value="{{ old("nome_ceo", $company->nome_ceo) }}">
		...
		<div class="form-group @if ($errors->has('data_inicio_contrato')) has-error @endif">
			...
			<input type="date" class="form-control" id="data_inicio_contrato" name="data_inicio_contrato" value="{{ old("data_inicio_contrato", $company->data_inicio_contrato) }}">
		...
		<div class="form-group @if ($errors->has('data_vigencia_1')) has-error @endif">
			...
			<input type="date" class="form-control" id="data_vigencia_1" name="data_vigencia_1" value="{{ old("data_vigencia_1", $company->data_vigencia_1) }}">
		...
		<div class="form-group @if ($errors->has('data_vigencia_2')) has-error @endif">
			...
			<input type="date" class="form-control" id="data_vigencia_2" name="data_vigencia_2" value="{{ old("data_vigencia_2", $company->data_vigencia_2) }}">
		...
		<div class="form-group @if ($errors->has('obs')) has-error @endif">
			...
			<input type="obs" class="form-control" id="obs" name="obs" value="{{ old("obs", $company->obs) }}">
			@if ($errors->has('obs'))
			<span class="invalid-feedback help-block" role="alert">
		...
		<div class="form-group @if ($errors->has('status_id')) has-error @endif">
			...
			<select class="form-control" id="status_id" name="status_id" value="{{ old("status_id", $company->status_id) }}" >
				@foreach ($status as $id => $desc_status)
				<option value="{{ $id }}" @if($id===$company->status_id) selected @endif>{{ $desc_status }}</option>
				@endforeach
			</select>
			...
			@endif
		</div>		<button type="submit" class="btn btn-success">Alterar Empresa</button>
	</fieldset>
</form>
@endsection